    ...
    <div class="container">
        <div class="footer-grids">
            ...
            <div class="col-md-3 footer-grid">
                ...
                <p>E-mail : <a href="mailto:example@mail.com"> hosting@cedhosting.com</a></p>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="copy-section">
            <p>&copy; 2016 Planet Hosting. All rights reserved | Design by <a href="https://keenpeeps.com">PapluCoder</a></p>
        </div>
    </div>
</div>
<!---footer--->
